...
|:-------------------------------:|:-------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------:|
| ![로그인](./README_assets/로그인.gif) | ![일기_작성](C:\Users\SSAFY\Desktop\깃허브\side-healing-diary\README_assets\일기_작성.gif) | ![달력_일기_데이터_조회](C:\Users\SSAFY\Desktop\깃허브\side-healing-diary\README_assets\달력_일기_데이터_조회.gif) |

| 소모임 생성                                | 소모임 초대                              |
|:-------------------------------------:|:-----------------------------------:|
| ![소모임_생성](./README_assets/소모임_생성.gif) | ![초대_기능](./README_assets/초대_기능.gif) |

| 일기 및 소모임 검색                         | 소모임 일기 조회                                       | 댓글 조회 및 작성                                    |
|:-----------------------------------:|:-----------------------------------------------:|:---------------------------------------------:|
| ![검색_기능](./README_assets/검색_기능.gif) | ![소모임_내_일기_조회](./README_assets/소모임_내_일기_조회.gif) | ![댓글_조회_및_작성](./README_assets/댓글_조회_및_작성.gif) |
